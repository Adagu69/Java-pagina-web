...
public class AlumnoModel  extends ConexionMySQL{
   ...
   private String alu_direccion;
    ...
    public AlumnoModel(String alu_id, String alu_nombres, String alu_apellidos, String alu_dni, String alu_telefono, String alu_direccion) {
        this.alu_id = alu_id;
