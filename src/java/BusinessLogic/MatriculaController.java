...
import BusinessEntity.MatriculaBean;
 ...
 * @author U-07
 */
public class MatriculaController extends ConexionMySQL implements IControllerBase<MatriculaBean> {
    ...
    public ArrayList<MatriculaBean> SelectAll() {
        ...
        String call = "{call prcMatriculaSelectAll()}";
        CallableStatement cstm = null;
        ResultSet res = null;
        try {
            cstm = getConexion().prepareCall(call);
            ...
            while (res.next()) {
                ...
                cMatricula.setId_alumno(res.getString("id_alumno"));
                cMatricula.setId_seccion(res.getString("id_seccion"));
